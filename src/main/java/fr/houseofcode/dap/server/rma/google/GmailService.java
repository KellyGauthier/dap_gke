...
public final class GmailService {
    ...
    private Gmail getGmailService(String userKey) throws GeneralSecurityException, IOException {
        ...
        Gmail service = new Gmail.Builder(hTTPTRANSPORT, Utils.getJsonFactory(), Utils.getCredentials(hTTPTRANSPORT, userKey))
    ...
    public int getNbUnreadEmail(String ukValue) throws IOException, GeneralSecurityException {
        ...
        ListMessagesResponse response = getGmailService(ukValue).users().messages().list("me").setQ("is:unread in:inbox").execute();
        ...
        while (response.getMessages() != null) {
            ...
            if (response.getNextPageToken() != null) {
                ...
                response = getGmailService(ukValue).users().messages().list("me").setQ("is:unread").setPageToken(pageToken)
                        .execute();
